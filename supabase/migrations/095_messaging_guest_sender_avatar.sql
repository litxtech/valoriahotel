-- Misafir mesaj gönderirken sender_avatar = guests.photo_url kullan.
...
DECLARE
  ...
  v_msg_id UUID;
BEGIN
  SELECT g.id, g.full_name, g.email, g.photo_url INTO v_guest_id, v_guest_name, v_guest_email, v_guest_photo
